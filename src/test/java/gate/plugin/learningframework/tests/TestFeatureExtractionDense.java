...
public class TestFeatureExtractionDense {
  ...
  public void extract2Json1() {
    ...
    CorpusRepresentationVolatileDense2JsonStream cr = new CorpusRepresentationVolatileDense2JsonStream(new File("test-cr-volatile.json"), fi);
    ...
    String instanceNameFeature = null;
    ...
    */
    ...
    //System.err.println("TestFeatureExtractionDense/extract2Json1 Debug: inst1_json="+inst1_json);   
    ...
    InstanceRepresentation instLong1 = cr.annotation2instance(longAnn,inputAS, classAS,
          targetFeatureName, TargetType.NOMINAL,
          weightFeature, null /* seqEncoder */);
    //System.err.println("TestFeatureExtractionDense/extract2Json1 Debug: instLong1="+instLong1);   
    String instLong1_json = cr.internal2Json(instLong1);
    //System.err.println("TestFeatureExtractionDense/extract2Json1 Debug: instLong1_json="+instLong1_json);   
